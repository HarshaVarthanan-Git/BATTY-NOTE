...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['username'], $_POST['password'])) {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $stmt = $db->prepare('INSERT INTO login_sessions (UA, session_id, status, user_id, date) VALUES (?, ?, ?, ?, NOW())');
        $stmt->execute([$ua, $session_id, 'active', $user['id']]);
...
<body>
    ...
    <div class="container">
        <div class="card">
            <h2>Sign In</h2>
            <p>Please enter your credentials to access Batty Notes</p>
